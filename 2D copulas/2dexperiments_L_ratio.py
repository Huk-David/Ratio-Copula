...
np.random.seed(101999)
torch.manual_seed(101999)
...
os.makedirs('model_parameters_L_ratio_25_runs_4copulas_2Dexperiment_next', exist_ok=True)
...
for r, run in (enumerate(sims_runs_all)):
    ...
    for u, u1_u2 in enumerate(run):
        ...
        model_path = f'model_parameters_L_ratio_25_runs_4copulas_2Dexperiment_next/L_ratio_run_{r}_cop_u_{u}_model.pkl'
        poly_path = f'model_parameters_L_ratio_25_runs_4copulas_2Dexperiment_next/L_ratio_run_{r}_cop_u_{u}_poly.pkl'
...
with open('model_parameters_L_ratio_25_runs_4copulas_2Dexperiment_next/L_ratios_all_25_runs_4copulas_2Dexperiment.pkl', 'wb') as f:
