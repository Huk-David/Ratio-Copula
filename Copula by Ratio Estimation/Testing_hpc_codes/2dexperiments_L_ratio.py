...
for r, run in (enumerate(sims_runs_all)):
    ...
    for u, u1_u2 in enumerate(run):
        ...
        # Fit Ratio copula
        ratio = W_L_ratio_fit(z_cop=p_data, z_indep=q_data, waymarks=2, degrees=5)
...
with open('model_parameters_L_ratio_25_runs_4copulas_2Dexperiment/L_ratios_all_25_runs_4copulas_2Dexperiment.pkl', 'wb') as f:
